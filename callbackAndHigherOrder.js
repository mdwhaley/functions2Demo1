...
/*
  Write a function called multiply that takes in three 
  parameters: two numbers and a callback function.  
  Invoke the callback, passing in the product of the two 
  numbers multiplied as the argument. 
*/
...
/* 
  Write a function called each that takes in an array of 
  names and a callback function. 
  For each name in the array, invoke the callback and 
  pass in the name and the name's index as arguments.
*/

// CODE HERE
const each = (arr, cb) => arr.forEach((name, index) => cb(name, index));
/*
  Invoke the each function, passing in the names array and a 
  callback function.
...
// CODE HERE
let favNumber = addTen(17);
console.log(favNumber);
let someNum = addTen(999);
console.log(someNum);
...
// CODE HERE
const addNumber = addingFactory(27);
