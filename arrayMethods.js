...
/*
  ...
  adding in the sales tax (given to you as a tax rate, hint: 
    you'll need to do some multiplication). Your answer should be 
    an array of numbers, one total for each order.
*/

// CODE HERE
const orderTotals = orders.map((num) => num.price + num.price * num.tax);
...
// CODE HERE
const bobs = purchases.filter((name) => name.owner === "Bob");
const bobsPrice = bobs.reduce((acc, curr) => acc + curr.price, 0);
console.log(bobs);
console.log(bobsPrice);
